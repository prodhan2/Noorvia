  ...
  AppBar _buildAppBar() {
    return AppBar(
      ...
      title: Column(
        ...
        children: [
          Text('প্রশ্ন ও উত্তর', style: GoogleFonts.hindSiliguri(fontSize: 17, fontWeight: FontWeight.w800, color: Colors.black, height: 1.2)),
          Text('রুকইয়াহ বিষয়ক সাধারণ জিজ্ঞাসা', style: GoogleFonts.hindSiliguri(fontSize: 10, color: Colors.black, height: 1.2)),
        ],
      ),
      actions: [
        IconButton(
